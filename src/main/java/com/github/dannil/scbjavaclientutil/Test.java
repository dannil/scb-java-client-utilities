...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // Retrieve some client(s) matching the table(s) you want to fetch information
        // from
        ...
        // You may also want to skip the explicit creation of the matching client and
        // fetch data
        ...
        // Specify the table to retrieve from. The response will be a JSON string
        // containing all the
        // available data from our specified table.
        String json = client.getRawData("BE/BE0101/BE0101A/BefolkningNy");

        // Fetch all available inputs for a table. Every key in the map corresponds to an
        // available input
        // parameter and the values for a specific key are all the available values for a
        // specific input.
        // The contents of availableInputs can then be analyzed and used for fetching more
        // specific data.
        ...
        // The contents code BE0101N1 (the total population, so the API knows what
        // information we want)
        ...
        // Specify the table to retrieve from and our inputs to this table. The response
        // will be a JSON
        ...
        // Retrieve all the entries having the code "alder" with either value 45 or 50 and
        // the code
        // "region" with value 01.
        Map<String, Collection<String>> inputs2 = new HashMap<>();
        inputs2.put("alder", Arrays.asList("45", "50"));
        inputs2.put("region", Arrays.asList("01"));
